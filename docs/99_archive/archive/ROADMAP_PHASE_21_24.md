...
- **StyleProfile reference_env_tags / reference_camera_tags 추가**: StyleProfile에 JSONB 필드 2개 추가. ORM, StyleContext, PromptBuilder, preview.py, controlnet.py, schemas.py 수정. Alembic 마이그레이션 + 기존 5개 프로필 시딩. 테스트 4개 추가 (총 155개 통과). DB_SCHEMA.md 동기화.
