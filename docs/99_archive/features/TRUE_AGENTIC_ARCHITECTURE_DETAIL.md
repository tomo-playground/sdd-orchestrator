...
이하 내용은 원본 기능 명세의 Section 3~12 (단계별 전환 계획, State 확장 설계, 비용 가드레일, 리스크 대응, 테스트 전략, 벤치마크 샘플 등)를 포함합니다. Phase 10 완료(2026-02-18)로 인해 아카이브되었습니다.

> 실제 구현은 설계와 다소 차이가 있을 수 있습니다. 최신 구현 상태는 소스 코드 및 AGENT_SPEC.md를 참조하세요.
