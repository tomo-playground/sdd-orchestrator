...
> 상태: 미착수 | 설계 문서: [SOFT_DELETE.md](../../03_engineering/backend/SOFT_DELETE.md)
...
| # | 기준 |
|---|------|
| 1 | 삭제된 항목이 기본 목록에 표시되지 않음 |
| 2 | Trash에서 삭제된 항목 조회 가능 |
| 3 | 복원 시 원래 상태로 완전 복귀 (하위 Scene 포함) |
| 4 | 영구 삭제 시 기존 cleanup 로직 정상 동작 |
| 5 | 30일 경과 항목 자동 영구 삭제 |
| 6 | 기존 테스트 전체 통과 + 신규 테스트 추가 |
