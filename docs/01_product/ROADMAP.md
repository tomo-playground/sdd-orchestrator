...
| **Phase 30 (Character Consistency V2)** | **진행 중** — Sub-Phase A(Config 튜닝)+B(Gemini 복장 고정) 완료. NoobAI-XL 비교 테스트+Regional Prompter 멀티캐릭터 테스트 완료. C(Dual IP-Adapter) D(LoRA 트레이닝) E(Outfit Profile) F(Negative 복장 보호) G(멀티캐릭터 Inpaint 파이프라인) 미착수 |
