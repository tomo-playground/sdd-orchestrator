...
- **Phase 9**: Agentic AI Pipeline — **Phase 0~1.5 완료**, **Phase 2 Memory + Obs 완료** (2026-02-15). 8-노드 조건 분기 그래프, Quick/Full 모드 + Preset 3종, Revise 루프 + Human Gate, reasoning [왜?] 패널. **Phase 2**: AsyncPostgresStore Memory, LangFuse v3 Docker Observability, Research/Learn 노드 구현, 피드백 수집 API+UI, Memory 관리 Settings 탭. Phase 3 Creative 재평가 예정. [명세](FEATURES/AGENTIC_PIPELINE.md)
- **VRT Baseline**: 24개 스크린샷, 8개 스펙 완료 (6-7 #2)
- **테스트**: Backend 1,595 passed (13 skipped) + Frontend 299 passed = **총 1,894개**
