...
- **Phase 7-6**: Scene UX Enhancement **완료** (Phase A 3건 + Phase B #4 탭 분리 + #7 DnD 순서 변경 + Phase C #9~#12 Workspace 탭 재구성 + 품질 개선, #5~#6 취소)
...
| ~~3.5~~ | ~~7-6 C #9~11~~ | ~~Workspace 탭 + Pipeline 컴팩트 + 우측패널 통합~~ | ~~2026-02-13 완료~~ |

**Tier 1 — Feature 확장**
| 순위 | 출처 | 작업 | 근거 |
|------|------|------|------|
| 4 | 7-1 #8 | Character Builder 위저드 | 캐릭터 AI 에이전트화 선행 |
| 5 | 7-2 P2 | Channel DNA + Tag Intelligence | 프로젝트 차별화 |
| 6 | 7-1 #2 | Setup Wizard (첫 실행 가이드) | 현재 단일 사용자 |

**Tier 1.5 — Agentic AI 전환 (논의 중)**
| 순위 | 출처 | 작업 | 근거 |
|------|------|------|------|
