        ...
        <section className="grid gap-6 rounded-2xl border border-zinc-200/60 bg-white p-6 text-xs text-zinc-600 shadow-sm">
            ...
            <div className="flex flex-wrap items-center gap-3">
                ...
                <button
                    ...
                    className="rounded-full bg-indigo-600 px-4 py-2 text-[10px] font-semibold tracking-[0.2em] text-white uppercase disabled:bg-indigo-300 transition hover:bg-indigo-700"
                >
                    {isEvalRunning ? (
            ...
            <div className="grid gap-3">
                ...
                {TEST_PROMPTS.length > 0 && (
                    <button
                        ...
                        className="text-[10px] text-indigo-600 hover:underline w-fit"
                    >
