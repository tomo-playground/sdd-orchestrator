    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 border-t border-zinc-100 px-4 py-2 text-[12px] text-zinc-400">
          ...
          <span>
            <kbd className="rounded border border-zinc-200 bg-zinc-50 px-1 font-mono">↵</kbd> open
          </span>
          <span>
            <kbd className="rounded border border-zinc-200 bg-zinc-50 px-1 font-mono">esc</kbd>{" "}
            close
          </span>
        </div>
      </div>
