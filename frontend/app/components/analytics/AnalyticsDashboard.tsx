...
export default function AnalyticsDashboard({ storyboardId }: { storyboardId?: number | null }) {
  ...
  const categoryColors: Record<string, string> = {
    ...
    mood: "bg-indigo-500",
    clothing_top: "bg-red-500",
    clothing_bottom: "bg-red-400",
    clothing_outfit: "bg-red-500",
    clothing_detail: "bg-red-400",
    legwear: "bg-rose-500",
    footwear: "bg-rose-400",
    accessory: "bg-fuchsia-500",
    action_body: "bg-orange-500",
    action_hand: "bg-orange-400",
    action_daily: "bg-orange-500",
    time_of_day: "bg-sky-500",
    weather: "bg-sky-400",
    particle: "bg-sky-500",
    hair: "bg-orange-500",
  };
