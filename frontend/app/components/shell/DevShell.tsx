...
import DevSidebar, { NAV_GROUPS } from "./DevSidebar";
...
function DevNavBar() {
  ...
  const section = ALL_NAV_ITEMS.find((item) => pathname.startsWith(item.href))?.label ?? "Dev";

  return (
    <div className="flex items-center gap-3">
      <span className="text-xs font-semibold tracking-widest text-zinc-400 uppercase">Dev</span>
