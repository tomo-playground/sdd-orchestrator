...
describe('computeValidationResults', () => {
  describe('Script Validation', () => {
    ...
    it('should warn on long script (>40 chars)', () => {
      const scenes = [createScene({ script: 'This is a very long script that exceeds 40 characters' })];
      const { results } = computeValidationResults(scenes);
  ...
  describe('Summary Counts', () => {
    it('should count ok/warn/error correctly', () => {
      const scenes = [
        ...
        createScene({ id: 2, script: 'This is a very long script that exceeds 40 characters limit' }),
...
describe('getFixSuggestions', () => {
  describe('Script Fixes', () => {
    it('should suggest filling empty script', () => {
      ...
      const validation = { status: 'error' as const, issues: [
    ...
    it('should suggest trimming long script', () => {
      ...
      const validation = { status: 'warn' as const, issues: [
        { level: 'warn' as const, message: 'Script is longer than 40 characters.' }
      ]};
  ...
  describe('Prompt Fixes', () => {
    ...
    it('should suggest camera keywords', () => {
      ...
      const validation = { status: 'warn' as const, issues: [
        { level: 'warn' as const, message: 'Missing camera/shot keywords.' }
      ]};
    ...
    it('should suggest action keywords', () => {
      ...
      const validation = { status: 'warn' as const, issues: [
        { level: 'warn' as const, message: 'Missing action/pose keywords.' }
      ]};
    ...
    it('should suggest background keywords', () => {
      ...
      const validation = { status: 'warn' as const, issues: [
        { level: 'warn' as const, message: 'Missing background/setting keywords.' }
      ]};
    ...
    it('should suggest lighting keywords', () => {
      ...
      const validation = { status: 'warn' as const, issues: [
        { level: 'warn' as const, message: 'Missing lighting/mood keywords.' }
      ]};
  ...
  describe('Negative Prompt Fixes', () => {
    it('should suggest removing scene keywords from negative', () => {
      ...
      const validation = { status: 'warn' as const, issues: [
        { level: 'warn' as const, message: 'Negative Prompt contains scene keywords.' }
      ]};
