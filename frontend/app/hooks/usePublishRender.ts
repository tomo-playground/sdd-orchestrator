...
export function usePublishRender() {
  ...
  const store = useRenderStore(
    useShallow((s) => ({
      ...
      isSceneTextIncluded: s.isSceneTextIncluded,
      ...
      isAudioDuckingEnabled: s.isAudioDuckingEnabled,
    ...
    async (mode: "full" | "post") => {
      ...
      try {
        ...
        const payload = {
          ...
          is_scene_text_included: rs.isSceneTextIncluded,
          ...
          is_audio_ducking_enabled: rs.isAudioDuckingEnabled,
