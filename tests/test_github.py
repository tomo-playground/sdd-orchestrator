...
class TestRunGhCommand:
    ...
    async def test_successful_command(self):
        ...
        with patch("sdd_orchestrator.tools.github.asyncio.create_subprocess_exec") as mock_exec:
    ...
    async def test_gh_not_found(self):
        with patch(
            "sdd_orchestrator.tools.github.asyncio.create_subprocess_exec",
...
class TestMergePr:
    ...
    async def test_merge_success(self):
        ...
        with (
            ...
            patch("sdd_orchestrator.tools.rollback.start_post_merge_monitor"),
        ):
...
class TestTriggerSddReview:
    ...
    async def test_trigger_success(self):
        from sdd_orchestrator.tools.github import do_trigger_sdd_review
