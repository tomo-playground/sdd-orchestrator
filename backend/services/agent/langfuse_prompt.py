...
LANGFUSE_MANAGED_TEMPLATES: frozenset[str] = frozenset(
    {
        ...
        "creative/cinematographer/framing",
        "creative/cinematographer/action",
        "creative/cinematographer/atmosphere",
        "creative/cinematographer/compositor",
        "create_storyboard",
...
_TEMPLATE_TO_LANGFUSE: dict[str, str] = {
    ...
    "creative/cinematographer/framing": "pipeline/cinematographer/framing",
    "creative/cinematographer/action": "pipeline/cinematographer/action",
    "creative/cinematographer/atmosphere": "pipeline/cinematographer/atmosphere",
    "creative/cinematographer/compositor": "pipeline/cinematographer/compositor",
