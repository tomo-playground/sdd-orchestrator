...
from services.prompt.composition import PromptBuilder  # noqa: E402


def generate_with_builder():
    ...
    try:
        ...
        print("📝 Testing Generic Composition...")
        ...
        if image_b64:
            ...
            output_file = "db_verification.png"
