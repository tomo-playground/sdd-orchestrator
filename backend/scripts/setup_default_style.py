...
Based on ROADMAP.md current environment:
...
def main():
    ...
    try:
        # 1. SD Model
        print("📦 SD Models:")
        animagine, _ = get_or_create(db, SDModel, "animagine-xl.safetensors", {
            "display_name": "Animagine XL",
            "model_type": "checkpoint",
            "base_model": "SDXL",
            "description": "High quality anime-style SDXL model",
        })

        # 2. LoRAs
        print("\n🎨 LoRAs:")
        eureka, _ = get_or_create(db, LoRA, "eureka_v9", {
            "display_name": "Eureka V9",
            "trigger_words": ["eureka"],
            "default_weight": 1.0,
            "weight_min": 0.5,
            "weight_max": 1.5,
            "base_models": ["SDXL", "animagine-xl"],
            "character_defaults": {
        ...
        # 3. Embeddings
        print("\n🔖 Embeddings:")
        veryBad, _ = get_or_create(db, Embedding, "verybadimagenegative_v1.3", {
        ...
        easyNeg, _ = get_or_create(db, Embedding, "easynegative", {
        ...
        if existing_profile:
            ...
            profile = StyleProfile(
                ...
                display_name="Animagine Default",
                description="Default style with Animagine XL, Eureka, and Chibi Laugh LoRAs",
                sd_model_id=animagine.id,
                loras=[
