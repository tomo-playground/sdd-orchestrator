...
GENERIC_CHARACTERS = [
    {
        ...
        "reference_negative_prompt": "worst_quality, low_quality, lowres, bad_anatomy, (multiple_girls:1.5), (2girls:1.5), (multiple_people:1.5), nsfw, revealing_clothes, sexy, mature_female, blurry, text, watermark",
    },
    {
        ...
        "reference_negative_prompt": "worst_quality, low_quality, lowres, bad_anatomy, (multiple_boys:1.5), (2boys:1.5), (multiple_people:1.5), nsfw, feminine, breasts, long_eyelashes, lipstick, makeup, muscular, shirtless, mature_male, blurry, text, watermark",
    },
]
