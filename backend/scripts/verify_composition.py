...
def verify_composition_logic():
    db = SessionLocal()
    try:
        print("🧪 Testing 12-Layer Prompt Composition...")
        ...
        # 3. Build Prompt
        prompt = builder.compose(tags=tags, character_loras=[char_lora], style_loras=[style_lora])
