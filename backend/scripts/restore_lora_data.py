...
def restore_and_fix():
    ...
    try:
        ...
        if not fc_alias:
            ...
            db.add(TagAlias(source_tag="flat_color", target_tag="flat_color, <lora:flat_color:0.8>", is_active=True))
        ...
        if not geo_alias:
            ...
            db.add(
                TagAlias(source_tag="geometric", target_tag="geometric, <lora:Gentle_Cubism_Light:0.8>", is_active=True)
            )
