...
class TestInjectLorasDedup:
    ...
    def test_inject_loras_style_lora_added_when_not_triggered(self, mock_trigger_cache, builder):
        """style_loras not in scene tags → LoRA tag added, trigger words NOT injected (ComfyUI handles natively)."""
        ...
        # ComfyUI: trigger words are NOT injected into prompt (LoRA node applies directly)
        assert "flat color" not in atmo_tokens
