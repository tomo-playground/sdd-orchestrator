...
class TestValidateControlnetPoses:
    ...
    def test_underscore_format_normalized(self):
        ...
        _validate_controlnet_poses(scenes)
        assert scenes[0]["controlnet_pose"] == "from behind"
        assert scenes[1]["controlnet_pose"] == "profile standing"
