...
class TestResolutionStrategy(unittest.TestCase):
    def test_image_ops_fit_top_centering(self):
        ...
        self.assertEqual(center_pixel, (255, 0, 0), "Expected red pixel from top half, got {}".format(center_pixel))
    ...
    def test_image_ops_fit_default_centering(self):
        ...
        center_pixel = cropped.getpixel((50, 50))
        self.assertEqual(center_pixel, (0, 128, 0), "Expected green pixel from middle, got {}".format(center_pixel))
