...
down_revision: Union[str, Sequence[str], None] = '136a62ea8e04'
...
def upgrade() -> None:
    """Upgrade schema."""
    op.add_column('storyboards', sa.Column('casting_recommendation', postgresql.JSONB(astext_type=sa.Text()), nullable=True))
