...
def upgrade() -> None:
    ...
    op.add_column("activity_logs", sa.Column("media_asset_id", sa.Integer(), nullable=True))

    # 2. Add index for performance
    op.create_index("ix_activity_logs_media_asset_id", "activity_logs", ["media_asset_id"])
