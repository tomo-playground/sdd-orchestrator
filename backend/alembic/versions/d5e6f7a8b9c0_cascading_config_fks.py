...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        ...
        ['default_character_id'], ['id'], ondelete='SET NULL',
    )
    ...
    op.create_foreign_key(
        ...
        ['default_style_profile_id'], ['id'], ondelete='SET NULL',
    )
    ...
    op.create_foreign_key(
        'fk_groups_default_character_id', 'groups', 'characters',
        ['default_character_id'], ['id'], ondelete='SET NULL',
    )
    ...
    op.create_foreign_key(
        'fk_groups_default_style_profile_id', 'groups', 'style_profiles',
        ['default_style_profile_id'], ['id'], ondelete='SET NULL',
    )
