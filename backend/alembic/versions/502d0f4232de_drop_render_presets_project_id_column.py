...
down_revision: Union[str, Sequence[str], None] = 'd98cd7a8d450'
...
def downgrade() -> None:
    ...
    op.create_foreign_key(op.f('render_presets_project_id_fkey'), 'render_presets', 'projects', ['project_id'], ['id'], ondelete='CASCADE')
