...
down_revision: Union[str, Sequence[str], None] = '658f2762be74'
...
def downgrade() -> None:
    ...
    op.add_column('characters', sa.Column('reference_source_type', sa.VARCHAR(length=20), autoincrement=False, nullable=True))
