...
async def git_undo_last_commit() -> None:
    """Undo the most recent local commit, keeping changes unstaged (git reset HEAD~1)."""
    from sdd_orchestrator.config import PROJECT_ROOT
    ...
    try:
        ...
        logger.warning("git reset HEAD~1 failed (non-fatal)")
